...
Hourly data for February and March 2020 were used for the modelling and predictions. The plan going forward is to automate the inclusion of all applicable hourly data into the ever-growing training dataset as they occur. Temporal data inclusion is imperative as it will be a key independent variables that represents the change in the minig block over time. The different models will than automatically retrain on a weekly basis and potentially improve their prediction capability.The ultimate aim of the projects are to move from the predictive to prescriptive space.
